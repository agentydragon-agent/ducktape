{
  ...
  inputs = {
    ...
    claude-hooks-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/claude-hooks-d64111cb/claude_hooks-0.1.0-py3-none-any.whl";
      flake = false;
    };
    headscale-cleanup-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/headscale-cleanup-3358d587/headscale_cleanup-0.1.0-py3-none-any.whl";
      flake = false;
    };
    gterm-theme-wheel = {
