...
and exporting to JSONL in TEST_UNDECLARED_OUTPUTS_DIR.
...
class TracingConfig:
    ...
    def export_to_file(self, filename: str = "otel_spans.jsonl") -> Path | None:
        """Export collected spans to TEST_UNDECLARED_OUTPUTS_DIR as JSONL.

        Returns the path written, or None if no exporter configured or no spans.
        """
