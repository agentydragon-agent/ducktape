...
Usage:
    ...
    bazel run //experimental/benchmark_ollama:benchmark_ollama -- --niah-samples 0  # skip NIAH
    bazel run //experimental/benchmark_ollama:benchmark_ollama -- --unload-between-models
