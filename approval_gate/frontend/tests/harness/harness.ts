...
const PENDING_BASH: Action = {
  ...
  call: { tool_name: "bash", arguments: { argv: ["rm", "-rf", "/tmp/test"] } },
...
const PENDING_PYTHON: Action = {
  ...
  call: { tool_name: "python_exec", arguments: { code: 'print("hello world")' } },
...
const DONE_SUCCEEDED: Action = {
  ...
  call: { tool_name: "bash", arguments: { argv: ["ls", "-la", "/home"] } },
