...
def test_config() -> OptimizerConfig:
    ...
    return OptimizerConfig(
        ...
        tokens=TokenConfig(max_response_tokens=1000, reasoning_buffer_tokens=500, max_context_tokens=5000, max_files_tokens=2000),
        truncation=TruncationConfig(max_file_size_grading=10000, max_file_size_pattern_analysis=10000, log_message_length=200),
