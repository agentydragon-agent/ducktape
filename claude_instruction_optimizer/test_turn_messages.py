...
class Turn:
    ...
    def messages(self) -> List[Dict[str, Any]]:
        ...
        for i, reasoning_item in enumerate(self.reasoning):
            print(f"Processing reasoning item {i}: type={type(reasoning_item)}, repr={repr(reasoning_item)}")
            ...
            if hasattr(reasoning_item, 'model_dump'):
                ...
                print(f"Unknown reasoning item format at index {i}: type={type(reasoning_item)}, repr={repr(reasoning_item)}")
...
def test_turn_messages():
    ...
    full_input = [
        {"role": "system", "content": "You are a prompt engineer. Analyze the previous turn and improve the prompt."}
    ] + messages
