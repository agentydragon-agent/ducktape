...
- Backup infrastructure (devenv `pg_backup` + `bazelisk run //props/core:props -- db backup/restore/list-backups`)
...
- DB → YAML export: `bazelisk run //props/core:props -- gt export`
...
- `bazelisk run //props/core:props -- grader-agent list pending` — Query missing edges
- `bazelisk run //props/core:props -- grader-agent show issue/gt` — Inspect issues/occurrences
- `bazelisk run //props/core:props -- grader-agent match` — Create edges with credit
- `bazelisk run //props/core:props -- grader-agent fill` — Bulk-fill remaining edges
- `bazelisk run //props/core:props -- grader-agent delete` — Delete edges for redo
- `bazelisk run //props/core:props -- grader-agent submit` — Finalize grading
...
- Unified CLI: both modes use `bazelisk run //props/core:props -- grader-agent` (deleted separate `grader-daemon` CLI)
