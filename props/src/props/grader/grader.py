...
from props.grader.models import FalsePositiveID, GraderInput, KnownFalsePositive, TruePositiveID, TruePositiveIssue
from props.grader.persistence import fp_to_db, tp_to_db
from props.grader.submit_server import GraderSubmitServer
...
async def _run_grader_agent(
    *,
    ...
    # - HTTP MCP server with grader_submit tool
    # - Docker container with docker_exec
    # Snapshots are fetched by init script, not bind-mounted
