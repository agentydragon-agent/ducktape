...
def insert_tp_match(input_issue_id: str, tp_id: str, tp_occurrence_id: str, credit: float, rationale: str) -> None:
    ...
    Example:
        from props.grader.decision_helpers import insert_tp_match
...
def insert_fp_match(input_issue_id: str, fp_id: str, fp_occurrence_id: str, rationale: str) -> None:
    ...
    Example:
        from props.grader.decision_helpers import insert_fp_match
...
def insert_no_match(input_issue_id: str, rationale: str) -> None:
    ...
    Example:
        from props.grader.decision_helpers import insert_no_match
...
def delete_decision(input_issue_id: str) -> None:
    ...
    Example:
        from props.grader.decision_helpers import delete_decision
...
async def submit_grading(summary: str) -> None:
    ...
    Example:
        import asyncio
        from props.grader.decision_helpers import insert_tp_match, insert_no_match, submit_grading
