...
from props.models.true_positive import LineRange
...
def test_validation_accepts_single_true_positive():
    payload = LintSubmitPayload(
        message_md="OK", suggested_rationale=None, findings=[IssueLintFindingRecord(finding=TruePositive())]
    )
    assert isinstance(payload, LintSubmitPayload)
