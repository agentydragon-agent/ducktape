...
export type CriticRunDetail = components['schemas']['CriticRunDetail'];
export type GraderRunDetail = components['schemas']['GraderRunDetail'];
export type OtherAgentRunDetail = components['schemas']['OtherAgentRunDetail'];
export type AgentRunDetail = CriticRunDetail | GraderRunDetail | OtherAgentRunDetail;
