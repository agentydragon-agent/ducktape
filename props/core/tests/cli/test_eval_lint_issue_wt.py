...
from props_core.lint.lint_issue import lint_issue_run
...
async def test_iss014_anchor_windows(
    ...
    specimen = SnapshotSlug("2025-09-02-ducktape_wt")
    ...
    # TODO: When re-enabling this test, fetch snapshot content to a temp dir and pass as content_root
    payload = await lint_issue_run(
        ...
        content_root=Path("/tmp/specimen-content"),  # Placeholder - test is disabled (run=False)
    )
