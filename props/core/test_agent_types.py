...
class TestAgentConfig:
    ...
    def test_basic_construction_with_critic(self) -> None:
        ...
        config = AgentConfig(
            image_ref=BUILTIN_TAG, model="claude-sonnet-5", type_config=CriticTypeConfig(example=TEST_EXAMPLE)
        )
    ...
    def test_agent_type_property_delegates_to_type_config(self, type_config: TypeConfig) -> None:
        ...
        config = AgentConfig(image_ref="test", model="claude-sonnet-5", type_config=type_config)
