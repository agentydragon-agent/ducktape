...
from props_core.db.models import Base, Snapshot, SnapshotSlugColumn
...
class Example(Base):
    ...
    - Whole-snapshot: SELECT slug, 'whole_snapshot', NULL, n_catchable FROM snapshots
    - File-set: SELECT snapshot_slug, 'file_set', files_hash, n_catchable
