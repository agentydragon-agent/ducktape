...
Usage:
    ...
    from props_core.gepa.gepa_adapter import CriticAdapter, load_datasets
...
from props_core.db.examples import Example, get_examples_for_split
from props_core.db.models import AgentRun, AgentRunStatus, Event, RecallByDefinitionExample
from props_core.db.session import get_session
from props_core.db.snapshots import DBCriticSubmitPayload
