...
from props_core.db_event_handler import DatabaseEventHandler
from props_core.docker_env import DOCKER_MOUNT_PREFIX, PROPS_NETWORK_NAME, PropertiesDockerCompositor
...
class AgentEnvironment(ABC):
    ...
    async def __aenter__(self) -> PropertiesDockerCompositor:
        ...
        fetch_snapshot() from props_core.agent_helpers.
