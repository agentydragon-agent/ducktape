...
Provides:
- EvalClient: REST client for critic developer agents to call backend's /api/eval/run_critic
...
class EvalClient:
    ...
    Used by critic developer agents inside containers as a replacement for MCP.
