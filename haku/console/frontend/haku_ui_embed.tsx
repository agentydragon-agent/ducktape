...
// renders Haku's UI itself; it frames this origin and runs the trusted **frontend bridge**: the iframe may
...
export function HakuUiEmbed({
  ...
  // The frontend bridge listener stays registered for the tab's whole life, reached through a ref rather
  ...
  function onMessage(e: MessageEvent) {
    ...
    if (msg.type === "titleChanged") {
      // The frame is cross-origin, so a validated frontend bridge message is the only way for the
  ...
  // (open the link / fire the capability) and report the outcome back over the frontend bridge.
  function onApprove() {
