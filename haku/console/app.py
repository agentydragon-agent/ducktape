...
# The shell (top-level) may read geolocation for the `requestGeolocation` frontend bridge action, and
# capture the screen for the `requestScreenshot` frontend bridge action; `(self)` scopes both to the
