...
HostTaxLinkLiabilityI64 = Int64[np.ndarray, "tax_link liability"]
HostTaxLinkTaxLinkBool = Bool[np.ndarray, "tax_link other_tax_link"]
...
# JAX compiler/device columns and carry/state axes.
JaxCashBool = Bool[jax.Array, "cash"]
JaxCashI64 = Int64[jax.Array, "cash"]
JaxLotBool = Bool[jax.Array, "lot"]
JaxLotF64 = Float64[jax.Array, "lot"]
JaxLotI64 = Int64[jax.Array, "lot"]
JaxPropertyBool = Bool[jax.Array, "property"]
JaxPropertyF64 = Float64[jax.Array, "property"]
JaxPropertyI64 = Int64[jax.Array, "property"]
JaxLiabilityBool = Bool[jax.Array, "liability"]
JaxLiabilityF64 = Float64[jax.Array, "liability"]
JaxLiabilityI64 = Int64[jax.Array, "liability"]
JaxTaxProfileI64 = Int64[jax.Array, "tax_profile"]
JaxCapitalGainProfileI64 = Int64[jax.Array, "capital_gain_profile"]
JaxIncomeBucketI64 = Int64[jax.Array, "income_bucket"]
JaxTaxLinkBool = Bool[jax.Array, "tax_link"]
JaxTaxLinkF64 = Float64[jax.Array, "tax_link"]
JaxTaxLinkI64 = Int64[jax.Array, "tax_link"]
JaxTaxLinkIncomeBucketI64 = Int64[jax.Array, "tax_link income_bucket"]
JaxBracketF64 = Float64[jax.Array, "bracket"]
JaxBracketI64 = Int64[jax.Array, "bracket"]
JaxTaxLinkBracketF64 = Float64[jax.Array, "tax_link bracket"]
JaxTaxLinkBracketI64 = Int64[jax.Array, "tax_link bracket"]
JaxTaxLinkLiabilityI64 = Int64[jax.Array, "tax_link liability"]
JaxTaxLinkTaxLinkI64 = Int64[jax.Array, "tax_link other_tax_link"]
JaxTaxLiabilityI64 = Int64[jax.Array, "tax_liability"]
JaxCashflowI64 = Int64[jax.Array, "cashflow"]
JaxObligationBool = Bool[jax.Array, "obligation"]
JaxObligationI64 = Int64[jax.Array, "obligation"]
JaxBondBool = Bool[jax.Array, "bond"]
JaxBondF64 = Float64[jax.Array, "bond"]
JaxBondI64 = Int64[jax.Array, "bond"]
JaxMonthBondBool = Bool[jax.Array, "month bond"]
JaxMonthBondI64 = Int64[jax.Array, "month bond"]
JaxMonthPropertyBool = Bool[jax.Array, "month property"]
JaxMonthTaxLinkI64 = Int64[jax.Array, "month tax_link"]
JaxTaxLinkMonthI64 = Int64[jax.Array, "tax_link month"]
JaxPolicyCashBool = Bool[jax.Array, "policy cash"]
JaxPolicyI64 = Int64[jax.Array, "policy"]
JaxIssuerI64 = Int64[jax.Array, "issuer"]
JaxHarvestPolicyI64 = Int64[jax.Array, "harvest_policy"]
...
JaxRolloutLotI64 = Int64[jax.Array, "rollout lot"]
JaxIncomeBucketRolloutI64 = Int64[jax.Array, "income_bucket rollout"]
JaxCapitalGainProfileRolloutI64 = Int64[jax.Array, "capital_gain_profile rollout"]
...
JaxSaleI32 = Int32[jax.Array, "scheduled_sale"]
JaxSaleI64 = Int64[jax.Array, "scheduled_sale"]
JaxSaleSaleI64 = Int64[jax.Array, "scheduled_sale prior_sale"]
JaxSaleCapitalGainProfileI64 = Int64[jax.Array, "scheduled_sale capital_gain_profile"]
JaxSaleLotRolloutI64 = Int64[jax.Array, "scheduled_sale lot rollout"]
JaxHarvestPolicyLotI64 = Int64[jax.Array, "harvest_policy lot"]
JaxPolicySleeveRolloutI64 = Int64[jax.Array, "policy sleeve rollout"]

# Policy and monthly execution seams.
JaxSlotBool = Bool[jax.Array, "slot"]
JaxSlotF64 = Float64[jax.Array, "slot"]
JaxSlotI64 = Int64[jax.Array, "slot"]
JaxSlotRolloutBool = Bool[jax.Array, "slot rollout"]
JaxSlotRolloutF64 = Float64[jax.Array, "slot rollout"]
JaxSlotRolloutI64 = Int64[jax.Array, "slot rollout"]
...
JaxObligationObligationI64 = Int64[jax.Array, "obligation other_obligation"]
JaxObligationRolloutBool = Bool[jax.Array, "obligation rollout"]
JaxObligationRolloutI64 = Int64[jax.Array, "obligation rollout"]
JaxPolicyLotI64 = Int64[jax.Array, "policy_lot"]
JaxPolicyLotRolloutI64 = Int64[jax.Array, "policy_lot rollout"]
...
JaxEventRolloutBool = Bool[jax.Array, "event rollout"]
JaxRolloutTaxLinkI64 = Int64[jax.Array, "rollout tax_link"]
JaxTaxBreakdownTaxLinkRolloutI64 = Int64[jax.Array, "tax_breakdown tax_link rollout"]
...
JaxSnapshotRolloutI64 = Int64[jax.Array, "snapshot rollout"]
JaxPercentileI64 = Int64[jax.Array, "percentile"]
JaxSnapshotPercentileI64 = Int64[jax.Array, "snapshot percentile"]
HostSnapshotI64 = Int64[np.ndarray, "snapshot"]
HostPercentileI64 = Int64[np.ndarray, "percentile"]
HostSnapshotPercentileI64 = Int64[np.ndarray, "snapshot percentile"]
...
HostSnapshotIncomeBucketRolloutI64 = Int64[np.ndarray, "snapshot income_bucket rollout"]
HostSnapshotLotRolloutI64 = Int64[np.ndarray, "snapshot lot rollout"]
HostSnapshotCapitalGainClassRolloutBool = Bool[np.ndarray, "snapshot capital_gain_profile gain_class rollout"]
HostSnapshotCapitalGainClassRolloutI64 = Int64[np.ndarray, "snapshot capital_gain_profile gain_class rollout"]
...
HostLotRolloutI64 = Int64[np.ndarray, "lot rollout"]
HostSaleLotRolloutI64 = Int64[np.ndarray, "scheduled_sale lot rollout"]
HostPolicySleeveRolloutI64 = Int64[np.ndarray, "policy sleeve rollout"]
HostEventRolloutBool = Bool[np.ndarray, "event rollout"]
HostMonthPropertyRolloutBool = Bool[np.ndarray, "month property rollout"]
