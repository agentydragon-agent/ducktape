{
  ...
  inputs = {
    ...
    ducktape-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/ducktape-cff82144/ducktape-0.1.0-py3-none-any.whl";
      flake = false;
    };
    headscale-cleanup-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/headscale-cleanup-cff82144/headscale_cleanup-0.1.0-py3-none-any.whl";
      flake = false;
    };
    gterm-theme-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/gterm-theme-cff82144/gterm_theme-0.1.0-py3-none-any.whl";
      flake = false;
    };
