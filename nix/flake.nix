{
  ...
  inputs = {
    ...
    kubespand-bin = {
      url = "https://github.com/agentydragon/ducktape/releases/download/kubespand-ef05c308/kubespand";
      flake = false;
    };
    ducktape-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/ducktape-ef05c308/ducktape-0.1.0-py3-none-any.whl";
      flake = false;
    };
