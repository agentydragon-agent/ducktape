...
from devinfra.claude_hooks.supervisor.client import try_connect
from devinfra.claude_hooks.testing.mock_egress_proxy import EgressProxyConfig, MockEgressProxy
...
async def mock_egress_proxy() -> AsyncGenerator[MockEgressProxyFixture]:
    ...
    proxy_logger = logging.getLogger("devinfra.claude_hooks.testing.mock_egress_proxy")
