...
from devinfra.claude_hooks.testing.fixtures import MockEgressProxyFixture
from devinfra.claude_hooks.testing.mock_egress_proxy import MockEgressProxy, generate_mock_ca, generate_server_cert

# Register fixtures from module (pytest-native, no direct name import needed)
pytest_plugins = ["devinfra.claude_hooks.testing.fixtures"]
