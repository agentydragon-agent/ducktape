...
from devinfra.claude_hooks.platform_utils import get_platform
from devinfra.claude_hooks.settings import ENV_SESSION_DIR, HookSettings
...
def install_wrapper(settings: HookSettings, *, wrapper_dir: Path | None = None) -> Path:
    ...
    write_shell_wrapper(
        wrapper_path,
        "devinfra.claude_hooks.bazel_wrapper",
