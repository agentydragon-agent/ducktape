...
_MOCK_K8S_INFO = "_main/devinfra/claude/hook_daemon/session_start/mock_k8s_server.json"
_MOCK_K8S_ALIAS = "mock-k8s"

_CLIENT_INFO = "_main/devinfra/claude/hook_daemon/session_start/k8s_test_client.json"
...
def mock_k8s_image() -> str:
    return load_oci_image(_MOCK_K8S_INFO)


@pytest.fixture
def client_image() -> str:
    return load_oci_image(_CLIENT_INFO)
