...
//!
//! Functions decompiled from (offsets from e409c31a; not re-verified for 91c789ff):
...
//!
//! String refs (io.rs debug/error strings):
...
//!
//! String refs (io.rs stdout/stdin/ws messages):
...
//!
//! Server->Client message variant strings (Binary: 91c789ff):
...
//!   AttackAttemptUrl, HttpFormatIpSocket
//!
//! Client->Server message variant strings:
//!   SendSignal, ExpectStdIn
//!
//! New event type (Binary: 91c789ff):
//!   container_shutdown
...
/// Binary: 91c789ff adds: KeepAlive, Closed, AlreadyClosed, IoWriteBufferFull,
///   AttackAttemptUrl, HttpFormatIpSocket.
