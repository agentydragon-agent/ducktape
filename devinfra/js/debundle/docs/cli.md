...
| `debundle cluster <sym>`                                                               | no       | List the module-quotient neighbors of a binding's owner.                                                                                                                                                                                                                                                                                               |
| `debundle gate list`                                                                   | no       | List every blocking SCC in `cycles.json`. One row per entry: id, modules count, cut size. (Streaming via `--format ndjson`.)                                                                                                                                                                                                                           |
