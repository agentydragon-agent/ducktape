...
| `debundle show-source <id>` | no       | Print the source text for any identifier. Accepted ID kinds: binding (minified or readable), module path or module id (concatenated source of every owner statement in the module, in declaration order), proposal id, atom id, owner id, diagnostic id.                                                                                                             | shipped |
