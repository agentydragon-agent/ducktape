...
import { loadVendorRuntimeIndex, resolveVendorRuntimeRequest } from "../common/vendor_runtime_lib.mjs";
...
export function formatLiveProxyHelp() {
  return [
    "Usage: bazel run //devinfra/js/debundle/live_proxy:serve_live_proxy -- [options]",
    "",
    "Options:",
...
export function rewriteHtmlForLiveProxy(sourceHtml, { bootstrapUrl, uiVersion }) {
  ...
  const comment = "Generated by //devinfra/js/debundle/live_proxy:serve_live_proxy.";
