...
async def handle_navigate_to_worktree(config, worktree_name: str) -> None:
    ...
    elif click.confirm(f"Worktree '{worktree_name}' does not exist. Create it?", default=False):
        try:
