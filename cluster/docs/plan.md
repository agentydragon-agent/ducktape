...
- [ ] Tandoor: unsuspend and verify deployment works end-to-end (DB migration,
      Authentik proxy auth, recipe import)
- [ ] Tandoor: add to CNPG compliance table in `cnpg-conventions.md`
