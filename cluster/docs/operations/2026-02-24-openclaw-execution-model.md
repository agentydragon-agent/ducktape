...
The gateway process hosts MCP servers. The agent interacts with them through airlock
...
gateway process while letting the agent use them through airlock tools.
