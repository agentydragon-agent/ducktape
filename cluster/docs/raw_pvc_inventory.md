...
| `grocy-sf/grocy-config`                    | 1Gi    | local-path-hetzner     | Retained rollback | Old Grocy SF app data; replaced by `grocy-config-ovh`      |
| `grocy-sf/grocy-config-ovh`                | 1Gi    | local-path-ovh         | Active            | Grocy SF app data (SQLite + uploads)                       |
| `grocy-vallejo/grocy-config`               | 1Gi    | local-path-hetzner     | Retained rollback | Old Grocy Vallejo app data; replaced by `grocy-config-ovh` |
...
| ------------------------------------------ | ------------------ | ----------------- | -------------------------------------- |
| `grocy-sf/grocy-config`                    | talos-vps-worker-1 | Retained rollback | No live pod mounts it after cutover    |
| `grocy-vallejo/grocy-config`               | talos-vps-worker-1 | Retained rollback | No live pod mounts it after cutover    |
