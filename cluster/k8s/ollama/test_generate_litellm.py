...
def test_litellm_yaml_matches_generator() -> None:
    committed_text = get_required_path("ducktape/cluster/k8s/ollama/litellm.yaml").read_text()
    ...
    if committed != generated:
        pytest.fail(
            ...
            "Run: bazel run //cluster/k8s/ollama:generate_litellm_bin > cluster/k8s/ollama/litellm.yaml"
        )
