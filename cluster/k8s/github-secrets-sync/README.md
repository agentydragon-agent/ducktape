...
| Environments   | Read/write | `tf/gitops/github-secrets-sync` manages the protected `trusted-pr-ci` environment and its environment-scoped `SOPS_AGE_KEY` for explicitly approved fork revisions.                                                                                                             |
