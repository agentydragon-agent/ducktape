...
def main() -> int:
    # Usage: python -m jupyter_mcp_stdio_guard.kernel_exec --stderr-log /path/to/log -- [kernel args like -f {connection_file}]
    try:
        args = sys.argv[1:]
        ...
        target_mod = "jupyter_mcp_stdio_guard.kernel_shim" if diag else "ipykernel_launcher"
