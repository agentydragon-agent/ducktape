...
class PredicateContext:
    ...
    path: Optional[str] = None  # File path being operated on
    content: Optional[str] = None  # New content (for Write)
    old_content: Optional[str] = None  # Old content (for Edit)
    
    # Command information (for Bash)
    command: Optional[str] = None  # Command being executed
    
    # Session information
    session_id: str = "unknown"
    user: Optional[str] = None  # Future: user identification
