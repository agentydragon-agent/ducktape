...
- [ ] eval_harness.py: Remove duplicate class definition
  - File: `src/adgn_llm/properties/eval_harness.py`
...
- [ ] specimen_registry.py: jsonnet evaluate_file kwargs
  - File: `src/adgn_llm/properties/specimen_registry.py`
...
- [ ] tests: MiniCodex.create signature and client type
  - Files: `tests/mini_codex/test_exec_roundtrip.py`, `src/adgn_llm/llm_edit.py`, `src/adgn_llm/properties/agent_runner.py`, `src/adgn_llm/mini_codex/cli.py`
  - Issues:
...
- [ ] event_renderer.py: API rename
  - File: `src/adgn_llm/mini_codex/event_renderer.py`
...
- [ ] lint_issue.py: no-redef variable
  - File: `src/adgn_llm/properties/lint_issue.py`
...
- [ ] examples: Optional assignment
  - File: `src/adgn_llm/mini_codex/examples/run_minicodex_docker_demo.py`
  - Issue: Assigning `str | None` to `str`; supply default string before assignment.

- [ ] inop/engine/optimizer.py: multiple
  - File: `src/adgn_llm/inop/engine/optimizer.py`
  - Items:
