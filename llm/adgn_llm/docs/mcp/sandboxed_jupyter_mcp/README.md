...
```bash
/Users/mpokorny/code/ducktape/llm/adgn_llm/src/adgn_llm/mcp/sandboxed_jupyter_mcp/run_one.sh \
...
```bash
pytest -q llm/adgn_llm/src/adgn_llm/mcp/sandboxed_jupyter_mcp/tests/
```
