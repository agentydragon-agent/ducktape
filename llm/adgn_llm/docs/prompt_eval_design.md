...
## Links
- Critic server/payload: src/adgn_llm/properties/critic.py
- Grader server/payload: src/adgn_llm/properties/grader.py
- Specimen registry: src/adgn_llm/properties/specimens/registry.py
- Prompt builders: src/adgn_llm/properties/prompts/builder.py
- Inop optimizer (reference): src/adgn_llm/inop/engine/optimizer.py
