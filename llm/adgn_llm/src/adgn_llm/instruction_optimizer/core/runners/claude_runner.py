...
from adgn_llm.instruction_optimizer.core.containerized_claude import TaskClaude
from adgn_llm.instruction_optimizer.core.file_utils import collect_docker_files
            ...
            async with TaskClaude(
                ...
                async for message in claude.receive_messages():
                    ...
                    if isinstance(message, ClaudeAssistantMessage):
                        ...
                        if text:
                            trajectory.append(AssistantMessage(
                                text=text,
                                original=message,
                            ))
