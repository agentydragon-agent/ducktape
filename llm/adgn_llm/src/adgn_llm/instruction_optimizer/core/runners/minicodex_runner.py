...
from adgn_llm.instruction_optimizer.core.file_utils import collect_workspace_files
from adgn_llm.instruction_optimizer.core.logging_openai_client import LoggingOpenAIModel
...
from adgn_llm.instruction_optimizer.core.runners.base import AgentRunner
...
class MiniCodexRunner(AgentRunner):
    ...
    def __init__(self, runner_id: str, config: dict, *, openai_model: LoggingOpenAIModel):
    ...
    async def _run_command(self, cmd: list[str], timeout_s: int, cwd: str | None = None) -> tuple[int, str, str]:
    ...
    async def _run_command_local(self, cmd: list[str], timeout_s: int, cwd: str | None = None) -> tuple[int, str, str]:
    ...
    async def _run_command_docker(self, cmd: list[str], timeout_s: int, cwd: str | None = None) -> tuple[int, str, str]:
