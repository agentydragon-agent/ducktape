...
Only report findings that are NOT already listed in the embedded supplements above. This includes additional instances under existing properties, new categories under existing properties, or entirely new issues not covered by current properties.
