...
- [early-bailout](../../props/early-bailout.md)
...
- [scoped try/except](../../props/python/scoped-try-except.md)
...
- [truthfulness](../../props/truthfulness.md)
...
- [early-bailout](../../props/early-bailout.md), [minimize-nesting](../../props/minimize-nesting.md)
...
### [No useless documentation or comments](../../props/no-useless-docs.md)
...
### [Use walrus for trivial immediate conditions](../../props/python/walrus.md)
...
### [No one-off variables or trivial pass-through wrappers](../../props/no-oneoff-vars-and-trivial-wrappers.md)
...
### [Type correctness and specificity](../../props/type-correctness-and-specificity.md)
...
- [pathlib](../../props/python/pathlib.md)
...
- [Imports at the top](../../props/python/imports-top.md)
...
- [Pathlib usage (Python)](../../props/python/pathlib.md)
...
- [Use StrEnum for string‑valued enums (Python)](../../props/python/strenum.md)
  - Finding: Prefer StrEnum over Literal for string-valued tool policy.
  - Anchors:
    - llm/adgn_llm/src/adgn_llm/mini_codex/agent.py:101, 121

- [Forbid dynamic attribute access](../../props/python/forbid-dynamic-attrs.md)
...
- [Type hints (Python)](../../props/python/type-hints.md)
...
### [Modern type hints (PEP 604 unions, builtin generics)](../../props/python/type-hints.md)
...
- [Time and duration use rich time types](../../props/domain-types-and-units/time.md)
...
- [No unnecessary line breaks](../../props/no-extra-linebreaks.md)
...
- [no-oneoff-vars-and-trivial-wrappers](../../props/no-oneoff-vars-and-trivial-wrappers.md)
