...
I.issueWithOccurrences(
  ...
  occurrences=[
    ...
    { files: { 'internal/message/message.go': [ { start_line: 61, end_line: 72 }, { start_line: 239, end_line: 246 } ] }, note: 'Service.Delete(ctx, id string) and other interfaces use `id` param name — prefer messageID for clarity across API boundaries.' },
  ],
)
