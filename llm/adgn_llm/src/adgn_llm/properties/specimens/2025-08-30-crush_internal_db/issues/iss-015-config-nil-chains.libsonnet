...
I.issueWithOccurrences(
  ...
  occurrences=[
    ...
    { files: { 'internal/llm/tools/tools.go': [ { start_line: 1, end_line: 30 } ] }, note: 'Representative site for reading GrepTimeoutSecs, BashBlockedCommands, MaxToolOutputBytes — prefer config.GrepTimeoutSecs(), config.BashBlockedCommands() helpers or DI.' },
  ],
)
