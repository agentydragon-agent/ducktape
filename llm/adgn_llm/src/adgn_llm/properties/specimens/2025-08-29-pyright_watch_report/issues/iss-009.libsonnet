local obj = {
  ...
  instances: [
    {
      files: { 'pyright_watch_report.py': [{ start_line: 272, end_line: 279 }] },
      note: |||
    ...
    {
      files: { 'pyright_watch_report.py': [{ start_line: 135, end_line: 139 }] },
      note: |||
        Top excludes:
    ...
    {
      files: { 'pyright_watch_report.py': [{ start_line: 228, end_line: 231 }] },
      note: |||
        `dp = Path(dirpath)`:
    ...
    {
      files: { 'pyright_watch_report.py': [{ start_line: 246, end_line: 251 }] },
      note: |||
        ```python
    ...
    {
      files: { 'pyright_watch_report.py': [{ start_line: 253, end_line: 256 }] },
      note: |||
