import {
  to = authentik_application.grocy_mcp_sf
  id = "grocy-mcp-sf"
}

import {
  to = authentik_application.grocy_mcp_vallejo
  id = "grocy-mcp-vallejo"
}

import {
  to = authentik_application.grocy_sf
  id = "grocy-sf"
}

import {
  to = authentik_application.grocy_vallejo
  id = "grocy-vallejo"
}
...
import {
  to = authentik_application.kubectl_sandbox_client_credentials
  id = "kubectl-sandbox-client-credentials"
}

import {
  to = authentik_application.kubectl_sandbox_scoped
  id = "kubectl-sandbox-mcp"
}

import {
  to = authentik_application.manifold_mcp
  id = "manifold-mcp"
}

import {
  to = authentik_application.tana_mcp_facade
  id = "tana-mcp-facade"
}

import {
  to = authentik_group.grocy_sf_household
  id = "6439d8ea-e873-442e-8af4-bd99e049e1b3"
}

import {
  to = authentik_group.grocy_vallejo_household
  id = "fd907432-97cc-495b-b09a-faa68964cba5"
}

import {
  to = authentik_group.kubectl_sandbox_users
  id = "3f196e6f-d987-4b76-b243-b8c7cf41970c"
}

import {
  to = authentik_group.manifold_mcp_users
  id = "2f0813bf-b977-4d32-a7c8-244ce2315e5d"
}

import {
  to = authentik_group.tana_agentydragon_gmail_com_account_access
  id = "4bc75bab-9ba4-4bf5-bebb-833d8dc384dc"
}

import {
  to = authentik_policy_binding.grocy_mcp_sf_household
  id = "b37d3ef4-71f1-4dae-b00d-319be6778baa"
}

import {
  to = authentik_policy_binding.grocy_mcp_vallejo_household
  id = "4fd98b67-7d4a-4d91-93b0-525d4d680028"
}

import {
  to = authentik_policy_binding.grocy_sf_household
  id = "89e13afb-290d-41b0-94c0-d994ec5e9579"
}

import {
  to = authentik_policy_binding.grocy_vallejo_household
  id = "1633f3a0-f1e2-41aa-9449-f3a81be68d5c"
}

import {
  to = authentik_policy_binding.kubectl_passthrough_mcp_users
  id = "491864f8-403e-418d-9659-4582bf0ca076"
}

import {
  to = authentik_policy_binding.kubectl_sandbox_cc_auto_user
  id = "1a0c9a6e-81c5-455a-b58b-0396df93c693"
}

import {
  to = authentik_policy_binding.kubectl_sandbox_client_credentials
  id = "1680872e-bda1-4780-8276-80a866d40609"
}

import {
  to = authentik_policy_binding.kubectl_sandbox_scoped_users
  id = "ef62dc9a-780f-4b16-8f94-2a255bb2c5c9"
}

import {
  to = authentik_policy_binding.manifold_mcp_users
  id = "8e9ae296-d91a-4999-88d7-56decb711fb3"
}

import {
  to = authentik_policy_binding.tana_mcp_facade_account_access
  id = "766f1cf7-d879-4afa-aa5b-672e75b524f0"
}

import {
  to = authentik_property_mapping_provider_scope.kubectl_sandbox_fixed_groups
  id = "eda29aaf-5714-4ac8-b58e-e8f757560689"
}

import {
  to = authentik_provider_oauth2.grocy_mcp_sf
  id = "61"
}

import {
  to = authentik_provider_oauth2.grocy_mcp_vallejo
  id = "62"
}
...
import {
  to = authentik_provider_oauth2.kubectl_sandbox_client_credentials
  id = "79"
}

import {
  to = authentik_provider_oauth2.kubectl_sandbox_scoped
  id = "65"
}

import {
  to = authentik_provider_oauth2.manifold_mcp
  id = "117"
}

import {
  to = authentik_provider_oauth2.tana_mcp_facade
  id = "76"
}

import {
  to = authentik_provider_proxy.grocy_sf
  id = "64"
}

import {
  to = authentik_provider_proxy.grocy_vallejo
  id = "63"
}

import {
  to = authentik_token.agent_sa_token
  id = "agent-api-key"
}

import {
  to = authentik_user.agent_sa
  id = "13"
}

import {
  to = authentik_user.kubectl_sandbox_client_credentials
  id = "21"
}
