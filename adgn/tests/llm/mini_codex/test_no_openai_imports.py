    ...
    if offenders_all:
        ...
        raise AssertionError(
            (
                ...
                "(e.g., adgn.llm.openai_utils.*) which expose Pydantic models and a small\n"
...
@pytest.mark.parametrize(
    "rel_path",
    [
        "src/adgn/llm/mini_codex",
        "src/adgn/llm/git_commit_ai",
        "src/adgn/llm/llm_edit.py",
        "src/adgn/llm/properties",
    ],
)
