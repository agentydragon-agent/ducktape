...
from adgn.llm.mini_codex.ui.protocol import ToolCall, FunctionCallOutput, UiEndTurnEvt
from adgn.llm.mini_codex.ui.state import new_state
from adgn.llm.mini_codex.ui.reducer import reduce_ui_state
from adgn.llm.mini_codex.ui.shared_bus import UiBus, UiEndTurn
...
def test_regular_tools_not_affected():
    ...
    regular_call = ToolCall(name="mcp__echo__echo", call_id="echo-123", args_json='{"text": "test"}')
