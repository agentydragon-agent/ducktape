"""Test critic prompt discovery and sync to database."""
...
def test_list_critic_system_prompts():
    """Test that critic system prompts are discovered from critic/prompts/."""
    prompts = list_critic_system_prompts()
...
def test_sync_all_critic_prompts(test_db):
    """Test syncing all critic prompts from git to database."""
