"""Tests for the prompt_metrics_whole_repo example module.

Tests functions for whole-repo mode metrics (uses SECURITY DEFINER function).
Consolidated from: test_query_train_vs_valid_performance_whole_repo.
"""

from adgn.props.prompt_optimize.examples.prompt_metrics_whole_repo import show_train_vs_valid
