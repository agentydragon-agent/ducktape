...
from adgn.agent.mcp_manager import McpManager  # structured MCP snapshot types
from adgn.agent.ui.state import UiState
from adgn.agent.ui.shared_bus import MimeType
