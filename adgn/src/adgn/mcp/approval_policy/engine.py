...
from adgn.mcp._shared.constants import POLICY_READER_MOUNT_PREFIX, RUNTIME_MOUNT_PREFIX, UI_MOUNT_PREFIX
...
async def attach_approval_policy_readonly(
    comp: Compositor, engine: PolicyEngine, *, name: str = POLICY_READER_MOUNT_PREFIX
) -> EnhancedFastMCP:
    """Attach the policy reader server with the standard policy_reader mount prefix."""
