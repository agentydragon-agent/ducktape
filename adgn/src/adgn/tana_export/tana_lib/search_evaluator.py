"""
Evaluator for Tana search expressions.

This module provides functionality to execute parsed search expressions
against a NodeStore to find matching nodes.
"""
...
class SearchEvaluator:
    """Evaluates search expressions against a NodeStore."""
