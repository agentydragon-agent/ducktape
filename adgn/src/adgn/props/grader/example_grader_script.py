...
from adgn.props.db.models import CriticRun, FalsePositive, ReportedIssue, TruePositive
...
def load_critique_example():
    ...
    with get_session() as session:
        ...
        reported_issues = session.query(ReportedIssue).filter_by(critic_run_id=critic_run_id).all()
