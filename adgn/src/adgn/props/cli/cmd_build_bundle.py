...
TODO: Consider reorganizing this module:
- Most of the code is git/bundle manipulation logic, not CLI-specific
- Could extract to src/adgn/props/bundles/builder.py (implementation)
- Keep only the Typer command definition here (cmd_build_bundle)
- Would follow the pattern of cmd_db.py (CLI) vs db/ (implementation)
"""
