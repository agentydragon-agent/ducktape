...
| Output | Method |
|--------|--------|
| Create improved definition | CLI: `/workspace/bin/critic_dev.py create-definition /workspace/improved/` |
...
/workspace/bin/critic_dev.py fetch-base-critic /workspace/improved/

# Edit AGENT.md with your improvements based on failure analysis
# Submit your improved definition
/workspace/bin/critic_dev.py create-definition /workspace/improved/
```
...
- `docs/db/*` — Ground truth, critiques, grading, evaluation flow
