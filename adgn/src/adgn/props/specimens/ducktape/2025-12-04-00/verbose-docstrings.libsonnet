...
I.issueMulti(
  ...
  occurrences=[
    {
      files: {'src/adgn/mcp/_shared/calltool.py': [[61, 70]]},
      note: 'Docstring restates parameter names/types from signature; Returns section just says "instance of output_type"',
      expect_caught_from: [['src/adgn/mcp/_shared/calltool.py']],
    },
    {
      files: {'src/adgn/agent/transcript_handler.py': [[22, 32]]},
    ...
    {
      files: {'src/adgn/mcp/_shared/resources.py': [[61, 75]]},
    ...
    {
      files: {'src/adgn/agent/bootstrap.py': [[177, 185]]},
      note: 'read_resource_call docstring Args/Returns sections restate parameter types and return type',
      expect_caught_from: [['src/adgn/agent/bootstrap.py']],
    },
    {
      files: {'src/adgn/agent/bootstrap.py': [[196, 204]]},
