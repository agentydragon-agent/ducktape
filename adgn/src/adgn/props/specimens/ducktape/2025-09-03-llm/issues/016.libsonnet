...
I.issueWithOccurrences(
  ...
  occurrences=[
    ...
    { files: { 'llm/adgn_llm/src/adgn_llm/mini_codex/local_tools.py': [[26, 26]] }, note: 'function-local import in _run_proc' },
    { files: { 'llm/adgn_llm/src/adgn_llm/mini_codex/mcp_manager.py': [[101, 101]] }, note: 'function-local import in _sanitize_name' },
  ],
)
