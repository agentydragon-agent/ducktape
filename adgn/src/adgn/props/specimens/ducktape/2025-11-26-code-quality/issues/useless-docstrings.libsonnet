...
I.issueOccurrencesFromLines(
  ...
  linesByFile={
    'adgn/src/adgn/agent/runtime/handlers.py': [
      [25, 27],  // build_handlers: "Returns" line restates return type
    ],
    'adgn/src/adgn/agent/server/app.py': [
      [50, 52],  // default_client_factory: useless docstring
    ],
    'adgn/src/adgn/agent/runtime/container.py': [
      [128, 129],  // default_client_factory: mostly useless docstring
    ],
  },
)
