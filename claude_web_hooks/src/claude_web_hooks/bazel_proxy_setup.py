...
# Must match the load() path in BUILD: //.claude/claude-code-web:proxy_env.bzl
...
def setup_bazel_proxy() -> None:
    ...
    # Note: Bazel wrapper installation moved to bazelisk_setup.install_wrapper()
    # which is called from session_start.py after this function
